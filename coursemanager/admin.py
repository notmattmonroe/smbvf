...
class CourseAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ('Date information', {'fields': ['course_start_time', 'course_end_time', 'course_days_of_week', 'course_all_day', 'course_recurring', 'custom_start_date', 'custom_end_date', 'dropins']}),
