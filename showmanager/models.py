...
class act(models.Model):
    ...
    host_id         = models.ForeignKey('auth.User', related_name="host_id", blank=True,  null=True)
    ...
    #    return u'%s %s %s %s %s' % (self.song, self.user, self.host_id, self.kitten_id, self.show_name)
